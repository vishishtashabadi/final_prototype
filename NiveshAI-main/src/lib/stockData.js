...
function generateOHLCV(basePrice, days = 730, volatility = 0.02) {
  const data = [];
  let price = basePrice;
  const startDate = new Date('2023-04-15'); // Start 2 years earlier to match 730-day data

  // Multi-phase trend logic stretched across the full 730 days for realistic multi-year trends
  const phases = [
    { startDay: 0, endDay: days * 0.15, dailyBias: 0.0015 },
    { startDay: days * 0.15, endDay: days * 0.30, dailyBias: -0.0020 },
    { startDay: days * 0.30, endDay: days * 0.50, dailyBias: 0.0030 },
    { startDay: days * 0.50, endDay: days * 0.65, dailyBias: 0.0005 },
    { startDay: days * 0.65, endDay: days * 0.80, dailyBias: -0.0010 },
    { startDay: days * 0.80, endDay: days, dailyBias: 0.0025 },
  ];
...
export const STOCK_SEED_DATA = [
  {
    ...
    ohlcv_data: generateOHLCV(2850, 730, 0.015)
  },
  {
    ...
    ohlcv_data: generateOHLCV(3800, 730, 0.012)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1780, 730, 0.013)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1520, 730, 0.018)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1280, 730, 0.014)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1650, 730, 0.016)
  },
  {
    ...
    ohlcv_data: generateOHLCV(790, 730, 0.018)
  },
  {
    ...
    ohlcv_data: generateOHLCV(430, 730, 0.012)
  },
  {
    ...
    ohlcv_data: generateOHLCV(780, 730, 0.025)
  },
  {
    ...
    ohlcv_data: generateOHLCV(450, 730, 0.02)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1780, 730, 0.017)
  },
  {
    ...
    ohlcv_data: generateOHLCV(12200, 730, 0.014)
  },
  {
    ...
    ohlcv_data: generateOHLCV(160, 730, 0.03)
  },
  {
    ...
    ohlcv_data: generateOHLCV(8500, 730, 0.018)
  },
  {
    ...
    ohlcv_data: generateOHLCV(1600, 730, 0.016)
  },
  {
    ...
    ohlcv_data: generateOHLCV(2300, 730, 0.028)
  },
  {
    ...
    ohlcv_data: generateOHLCV(5100, 730, 0.019)
  },
  {
    ...
    ohlcv_data: generateOHLCV(2300, 730, 0.01)
  },
  {
    ...
    ohlcv_data: generateOHLCV(308, 730, 0.012)
  },
  {
    ...
    ohlcv_data: generateOHLCV(240, 730, 0.03)
  }
];
...
/**
 * Dynamically calculates a user-specific suitability score (0-100) based on
 * stock risk level, calculated volatility from OHLCV data, and user profile.
 * @param {Object} stock - A stock object from STOCK_SEED_DATA
 * @param {Object} userProfile - The user's FinancialProfile entity
 * @returns {number} - Suitability score between 0 and 100
 */
// Helper to calculate annualized volatility from OHLCV
...
export function calculateUserSuitability(stock, userProfile) {
  ...
  // Normalize volatility: 0% = 0 score, 100% = 100 score
  ...
  // Calculate dynamic suitability based on alignment
  // A higher user risk appetite/experience/goal should align with higher stock risk/volatility
  const userComposite = (userRiskScore + experienceScore + goalScore) / 3;
  const stockComposite = (stockRiskScore + volatilityScore) / 2;

  // Score is highest when stock risk matches user profile (closest to composite scores)
