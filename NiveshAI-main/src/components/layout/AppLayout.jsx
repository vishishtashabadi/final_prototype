    ...
    <div className="min-h-screen bg-background flex">
      ...
      `}>
        ...
        <div className="p-3 border-t border-border">
          <Link to="/profile" onClick={() => setSidebarOpen(false)} className="flex items-center gap-3 px-3 py-2 rounded-xl bg-popover hover:bg-popover/80 transition-colors">
            <div className="w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold text-background flex-shrink-0" style={{ background: 'linear-gradient(135deg, #00D4FF, #7B2FFF)' }}>
