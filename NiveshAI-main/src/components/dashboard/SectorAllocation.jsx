...
export default function SectorAllocation({ trades, stocks, sectorData }) {
  if (sectorData && sectorData.length > 0) return <SectorPie data={sectorData} />;
